...
export default function Condition4() {
  ...
  return (
    <div>
        <div className="flex flex-col bg-blue-200 mt-2 p-1 rounded-md">
            <p className='mb-2 box-decoration-clone text-xs text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-pink-500 px-2 font-bold'>ခွင့်ရက်ရှည်</p>
            {gOutData.length > 0 ? (
                gOutData.map((item) => (
